...
def repair_workflow_with_llm(
    ...
    system_prompt = (
        ...
        "可用工具：add_node/update_node/add_node_params/remove_node_params/modify_node_params_value/rename_node_params_key/update_edge/add_edge/remove_edge/remove_node/validate_workflow/submit_workflow。\n"
