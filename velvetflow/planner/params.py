...
def fill_params_with_llm(
    ...
    system_prompt = (
        ...
        "  count_if/filter_map/pipeline 支持使用 __agg__.condition 或 steps[].condition 编写 Mini-Expression AST（JSON 结构化表达式），"
        "  允许的形式：{\"const\": ...} / {\"var\": \"path.to.value\"} / {\"op\": \"==\", \"left\": {...}, \"right\": {...}} / {\"op\": \"and\", \"args\": [...]}/ {\"op\": \"not\", \"arg\": {...}} / {\"op\": \"exists\", \"arg\": {\"var\": \"...\"}}。\n"
        "  编写条件时请引用 item/value/field 上下文：例如 {\"op\": \"and\", \"args\": [ {\"op\": \">\", \"left\": {\"var\": \"item.score\"}, \"right\": {\"const\": 80}}, {\"op\": \"exists\", \"arg\": {\"var\": \"item.id\"}} ]}。\n"
