...
#readme-lang-zh:checked ~ .tabs-body #readme-tab-zh,
#readme-lang-en:checked ~ .tabs-body #readme-tab-en { display: block; }
</style>
<div class="lang-tabs">
<input type="radio" id="readme-lang-zh" name="readme-lang" checked>
<label for="readme-lang-zh">中文</label>
<input type="radio" id="readme-lang-en" name="readme-lang">
<label for="readme-lang-en">English</label>
<div class="tabs-body">
<div class="tab-content" id="readme-tab-zh">
...
- [docs/openai_token_security.md](docs/openai_token_security.md)：OpenAI 凭证安全保存、集成测试开关与最小权限建议。
...
<div class="tab-content" id="readme-tab-en">
## English Version
...
- [docs/quickstart.md](docs/quickstart.md): Install dependencies, build the index, and run the demo quickly.
- [docs/core_concepts.md](docs/core_concepts.md): Data models and reference rules for Workflow/Node/Edge/Binding.
- [docs/workflow_dsl_schema.md](docs/workflow_dsl_schema.md): Field descriptions, node types, and a complete DSL example.
- [docs/advanced_guide.md](docs/advanced_guide.md): Retrieval tuning, model swaps, async node recovery, and other advanced topics.
- [docs/internal_design.md](docs/internal_design.md): Execution engine/state-machine diagrams, design patterns, and module layering.
- [docs/troubleshooting.md](docs/troubleshooting.md): Common errors, self-check steps, and log locations.
- [docs/openai_token_security.md](docs/openai_token_security.md): Secure storage for OpenAI credentials, integration-test toggles, and least-privilege tips.
